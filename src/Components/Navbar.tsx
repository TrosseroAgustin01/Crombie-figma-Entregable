        ...
        <nav className="navbar navbar-light bg-white pt-3">
            <div className="container">
                ...
                <ul className="nav">
                    ...
                    <li className="nav-item">
                        <a className="nav-link  text-secondary" href='#'>Piercing</a>
                    </li>
                    <li className="nav-item">
